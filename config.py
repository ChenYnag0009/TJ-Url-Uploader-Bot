...
class Config(object):
    ...
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://cy503127:cy503127@urlupload.tjuxebf.mongodb.net/?retryWrites=true&w=majority&appName=URLUPLOAD")
